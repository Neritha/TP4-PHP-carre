      ...
      <tbody>
          ...
          foreach($lesGenres as $genre)
          {
              ...
              echo "<td class='col-md-2'><a href='index.php?uc=genre&action=update&num=".$genre->getNum()."' class='btn btn-primary'><i class='fas fa-pen'></i></a>
                    <a href='index.php?uc=genre&action=delete&num=".$genre->getNum()."' data-toggle='modal' data-message='Voulez-vous supprimer ce genre ?' data-suppr='index.php?uc=genre&action=delete&num=".$genre->getNum()."' class='btn btn-danger'><i class='far fa-trash-alt'></i></a></td>";
              echo "</tr>";
          }
          ?>
      </table>
