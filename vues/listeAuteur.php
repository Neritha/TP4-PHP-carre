    ...
    <tbody>
        ...
        foreach($lesAuteurs as $auteur){
            ...
            echo "<td class='col-md-2'><a href='index.php?uc=auteur&action=update&num=$auteur->num' class='btn btn-primary'><i class='fas fa-pen'></i></a>
                <a href='index.php?uc=auteur&action=update&num=$auteur->num' data-toggle='modal' data-message='Voulez-vous supprimer cette auteur ?' data-suppr='index.php?uc=auteur&action=delete&num=$auteur->num' class='btn btn-danger'><i class='far fa-trash-alt'></i></a></td>";
            echo "</tr>";
        }
        ?>
        </tbody>  
