...
<html lang="fr">
  <head>
    ...
    <title>TP PHP Victoria Carré</title>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="#">rechercher un auteur | pas ecore actionné</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="index.php?uc=nationalites&action=add"p">Ajouter une nationalité</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="index.php?uc=continents&action=add">Ajouter un continents</a>
          </div>
        </li>
      </ul>
    </div>
